      ...
      <div style={{ flex: 1, padding: "20px 22px", overflowY: "auto", display: "flex", gap: 18 }}>
        ...
        <div style={{ width: 210, flexShrink: 0, display: "flex", flexDirection: "column", gap: 12 }}>
          <Card style={{ textAlign: "center", padding: "22px 16px" }}>
            <div style={{ width: 64, height: 64, borderRadius: "50%", background: "rgba(16,185,129,.15)", border: "3px solid #10b981", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 10px", fontSize: 26, fontWeight: 900, color: "#34d399" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              ...
              <FF label="Birthdate">
                {editing
                  ...
                  : <div style={{ padding: "8px 10px", background: "#0f172a", borderRadius: 6, border: "1px solid #334155", fontSize: 13, color: "#cbd5e1", minHeight: 35 }}>{user.birthdate || <span style={{ color: "#475569" }}>—</span>}</div>}
              </FF>
            </div>
